...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 68.0, 179.0, 53.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 53.5, 144.0, 17.0 ],
					"text" : "bitcrash~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 16.5, 144.0, 17.0 ],
					"text" : "overdrive~",
					"textcolor" : [ 1.0, 0.588235294117647, 0.588235294117647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 29.5, 144.0, 17.0 ],
					"text" : "lores~",
					"textcolor" : [ 1.0, 0.588235294117647, 0.588235294117647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 41.5, 144.0, 17.0 ],
					"text" : "degrade~",
					"textcolor" : [ 1.0, 0.588235294117647, 0.588235294117647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 18.0, 181.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 362.0, 148.0, 147.0, 22.0 ],
					"text" : "actmaker djrone_fx ff9680",
					"varname" : "act"
				}
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.0, 127.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 362.0, 169.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 362.0, 190.0, 107.0, 22.0 ],
					"text" : "pattrmarker no",
					"varname" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 362.0, 211.0, 107.0, 22.0 ],
					"restore" : 					{
						"master" : [ 0 ],
						"pres_menu" : [ "_" ],
						"processing" : [ 0.38121546961326, 0.414364640883978, 0.441988950276243, 0.447513812154696 ],
						"tetris_menu" : [ "" ],
						"title_menu" : [ "titlebar" ]
					}
,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 11.5, 261.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 10.0, 27.0, 83.0, 22.0 ],
									"text" : "ll.r~ in_mix~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 10.0, 90.0, 74.0, 22.0 ],
									"text" : "mc.unpack~"
								}
...
,
									"patching_rect" : [ 1007.5, 124.0, 792.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1808.5, 124.0, 79.0, 19.0 ],
									"text" : "scale 0. 1. 1 16"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 1007.5, 159.0, 808.0, 19.0 ],
									"text" : "degrade~ 1 16"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 11.5, 225.0, 60.0, 22.0 ],
									"text" : "mc.pack~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 354.0, 15.0, 83.0, 22.0 ],
...
,
									"patching_rect" : [ 11.5, 124.0, 792.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 812.5, 124.0, 79.0, 19.0 ],
									"text" : "scale 0. 1. 1 16"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 440.666666666666629, 78.0, 101.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 354.0, 78.0, 79.0, 19.0 ],
									"text" : "scale 0. 1. 1 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 11.5, 159.0, 808.0, 19.0 ],
									"text" : "degrade~ 1 16"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 354.0, 46.0, 444.0, 19.0 ],
									"text" : "unpack 0. 0. 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 207.0, 27.0, 100.0, 22.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"text" : "thispatcher",
									"varname" : "subTP"
								}
...
,
					"patching_rect" : [ 189.0, 203.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 375.0, 103.0, 100.0, 22.0 ],
					"restore" : [ "in_mix~(2)" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
		...
		"autosave" : 0,
		"bgcolor" : [ 1.0, 0.588235294117647, 0.501960784313725, 1.0 ]
	}
